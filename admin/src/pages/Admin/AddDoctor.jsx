...
const AddDoctor = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[120vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          ...
          <div>
            ...
            <div className='mt-4 mb-2'>
              <p>About Doctor</p>
              <textarea onChange={(e)=>{setAbout(e.target.value)}} value={about} className='w-full border rounded px-4 pt-2' placeholder="Write about the doctor" rows={5} required></textarea>
            </div>

          </div>
          <button type='submit' className='mt-4 font-semibold px-7 py-2 rounded-full bg-primary text-white hover:shadow-lg transition-all duration-300'>Add Doctor</button>
      </div>
    </form>
  )
}
