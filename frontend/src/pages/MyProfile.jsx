  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>

      {
        ...
        : <img className='rounded-md w-36' src={userData.image} alt="" />
      }
      ...
      <div>
        ...
        <div className='mt-10'>
          {
            isEdit
            ? <button className='border border-primary px-8 py-2 rounded-full hover:text-white hover:bg-primary transition-all' onClick={updateUserProfileData}>Save</button>
            :
