...
const addDoctor = async (req, res) => {
    try {
        ...
        // console.log( { name, email, password, speciality, about , fee, address }, imageFile);
        ...
        const uploadImage = await cloudinary.uploader.upload(imageFile.path , {resourse_type: "image"})
...
// API yo get dashboard data for admin panel
