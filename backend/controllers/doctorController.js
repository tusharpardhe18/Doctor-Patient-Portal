...
const loginDoc = async (req, res) => {
    try {
        ...
        if(!doc) return res.json({success:false, message: "Invalid email or password"})
...
export {changeAvailablity, doctorList, loginDoc, getDocAppointments, markAppointmentCompleted, markAppointmentCancel, getDashData, getDocProfile, editDocProfile}
